...
## Angels-MacBook-Pro:09_week angel\$ git status

On branch main Your branch is up to date with 'origin/main'.

nothing to commit, working tree clean

## Angels-MacBook-Pro:09_week angel\$ git log -1

commit f5ae613c57669b32b4423b872dd37f74627e1b53 (HEAD -\> main, origin/main, origin/HEAD) Author: aperez0103 [angel13per\@gmail.com](mailto:angel13per@gmail.com){.email} Date: Fri Mar 20 23:45:15 2026 -0400

```         
Totals vs proportions lab
```

Angels-MacBook-Pro:09_week angel\$
