...
\noindent \textbf{Pseudo-code expectation.} For Questions 2--5, include short pseudo-code comments in \texttt{scripts/lab.R} before each major block (for example: ``load data $\rightarrow$ derive variables $\rightarrow$ summarize $\rightarrow$ visualize").
