...
ggplot(ts, aes(x = year, y = estimate)) +
  ...
  theme_classic() +
  labs(x = NULL, y = "Index", title = "Trend with uncertainty ribbon")
```
...
ggplot(df, aes(x = estimate, y = country)) +
  ...
  labs(x = "Support (%)", y = NULL, title = "Public support for climate policy", subtitle = "Point estimates with 95% confidence intervals", caption = "Source: Simulated survey data (n varies by country)")
```
