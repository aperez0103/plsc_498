...
\item Customize and present an interactive visualization using \texttt{shiny} (built from a provided template) to support exploratory analysis or communication.
...
\begin{itemize}\compresslist
\item \textbf{Tuesday:} In-class working session: customize your Shiny app from the provided template and debug.
\item \textbf{Thursday (Presentations):} Final project presentations + wrap-up and reflection.
\item \textbf{Deliverables:} Final repo + figures + short write-up + customized Shiny app built from a course template.
\end{itemize}
...
\item A \textbf{customized Shiny app} built from one of the five course-provided templates (see \texttt{15\_week/data/}). You should adapt the template to work with your chosen dataset and tailor the visualizations, inputs, and layout to suit your project's narrative.
