...
\noindent \textbf{Pseudo-code expectation.} For Questions 2--6, include short pseudo-code comments in \texttt{scripts/lab.R} before each major block (for example: ``load data $\rightarrow$ clean/inspect $\rightarrow$ plot $\rightarrow$ save figure").
...
\end{verbatim}
  ...
  \begin{enumerate}
    ...
    \item Add 2--4 lines of pseudo-code before your inspection/summarizing code.
  ...
  \begin{itemize}
    \item Start this section with 3--5 pseudo-code lines describing your histogram workflow.
  ...
  \begin{itemize}
    \item Add 2--4 pseudo-code lines for your density-plot plan before coding.
  ...
  \begin{itemize}
    \item Add 2--4 pseudo-code lines for your Q--Q workflow before coding.
  ...
  \begin{itemize}
    \item Add 3--5 pseudo-code lines describing how you will facet by income and region.
